...
const PaginaThug: React.FC = () => {
    return (
        <>
            <NavBar />
            <main className="ffxiv-page thug-page">
                <header className="ffxiv-header" style={{ textAlign: 'center' }}>
                ...
                <section className="ffxiv-hero thug-hero">
                    <div className="thug-card">
                        <img src="/IMG/yun tug.jpg" alt="Young Thug - Look" />
                        <video src="/IMG/desfilethug.mp4" controls />
                    </div>
                </section>
